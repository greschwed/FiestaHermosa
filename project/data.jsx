// Shared mock data — insumos and receitas for Marmita
const INSUMOS = [
...
const CATEGORIAS_INSUMO = ['Grãos', 'Proteínas', 'Hortifruti', 'Mercearia', 'Embalagens', 'Laticínios', 'Temperos'];
...
const RECEITAS = [
  ...
  },
  {
    ...
    preparo: ['Corte a carne em tiras finas', 'Refogue cebola e alho', 'Adicione carne e doure', 'Acrescente molho de tomate', 'Finalize com creme de leite'],
  },
...
const CATEGORIAS_RECEITA = ['Fitness', 'Tradicional', 'Vegano', 'Vegetariano', 'Low carb'];

window.MARMITA_DATA = { INSUMOS, RECEITAS, CATEGORIAS_INSUMO, CATEGORIAS_RECEITA, UNIDADES };

// Helpers
window.fmtBRL = (n) => 'R$ ' + (n || 0).toFixed(2).replace('.', ',');
window.fmtNum = (n, d = 2) => (n || 0).toFixed(d).replace('.', ',');
